locals {
  ...
  exclude = feature.initial_apply.value || !try(local.inputs.locals.argocd.minio_operator.enabled, true)
}
...
inputs = try(local.inputs.locals.argocd.minio_operator.inputs, {})

variable "chart" {
  ...
  default     = "temporal-operator"
}

variable "repository" {
  type        = string
  description = "The URL of the chart repository"
  default     = "https://alexandrevilain.github.io/temporal-operator"
}
...
variable "metadata" {
  type = object(
    {
      name      = optional(string, "temporal-operator")
  ...
  type = object(
    {
      ...
      namespace = optional(string, "temporal")
    }
  )
  default     = {}
